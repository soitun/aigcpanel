...
import VideoSpeedParamDialog from "../components/VideoSpeedParamDialog.vue";
import VideoSpeedParamView from "../components/VideoSpeedParamView.vue";
...
const paramDialog = ref<InstanceType<typeof VideoSpeedParamDialog>>();
</script>

<template>
    <div class="p-2 relative">
        <div>
            <VideoSpeedParamView v-if="nodeData.speed" :data="nodeData" />
    ...
    <VideoSpeedParamDialog ref="paramDialog" @update="nodeUpdateData" />
</template>
