...
import TextToVideoCreate from "./components/TextToVideoCreate.vue";
import TextToVideoItem from "./components/TextToVideoItem.vue";
...
useTaskChangeRefresh("TextToVideo", (bizId: string, type: TaskChangeType) => {
    doRefresh();
});
...
const doRefresh = async () => {
    const rawRecords = await TaskService.list("TextToVideo");
...
<template>
    <div class="p-5">
        ...
        />
        <div>
            <TextToVideoCreate @submitted="doRefresh" />
            <ListerTop
                class="mt-4"
