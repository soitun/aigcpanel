...
import AudioNormalParamDialog from "../components/AudioNormalParamDialog.vue";
import AudioNormalParamView from "../components/AudioNormalParamView.vue";
...
const paramDialog = ref<InstanceType<typeof AudioNormalParamDialog>>();
</script>

<template>
    <div class="p-2 relative">
        <div>
            <AudioNormalParamView
                v-if="nodeData.normalizationPercentage"
                :data="nodeData"
            />
    ...
    <AudioNormalParamDialog ref="paramDialog" @update="nodeUpdateData" />
</template>
