...
import ImageToVideoCreate from "./components/ImageToVideoCreate.vue";
import ImageToVideoItem from "./components/ImageToVideoItem.vue";
...
useTaskChangeRefresh("ImageToVideo", (bizId: string, type: TaskChangeType) => {
    doRefresh();
});
...
const doRefresh = async () => {
    const rawRecords = await TaskService.list("ImageToVideo");
...
<template>
    <div class="p-5">
        ...
        />
        <div>
            <ImageToVideoCreate @submitted="doRefresh" />
            <ListerTop
                class="mt-4"
