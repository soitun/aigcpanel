...
<template>
    <div class="pb-device-container bg-white h-full relative select-none flex">
        <div class="p-6 w-52 flex-shrink-0 border-r border-solid border-gray-100 overflow-x-hidden overflow-y-auto">
            <div class="p-2 rounded-lg mb-4 cursor-pointer" :class="tab === 'videoGen' ? 'bg-gray-200' : ''"
                @click="tab = 'videoGen'">
            ...
            <div class="p-2 rounded-lg mb-4 cursor-pointer" :class="tab === 'videoTemplate' ? 'bg-gray-200' : ''"
            ...
            <div class="p-2 rounded-lg mb-4 cursor-pointer" :class="tab === 'videoGenFlow' ? 'bg-gray-200' : ''"
